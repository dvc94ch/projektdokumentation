...
\begin{tabular}{|l|l|l|}
	...
	\hline 
	Projektleiter & Gesamtübersicht des Projektes halten
	Überprüfen ob Vorgaben eingehalten werden 
	Teammeetings organisieren und Informationsaustausch sicherstellen
	Kostenverwaltung & Eve \\ 
	\hline 
	Projektplaner & Aktualisieren des Terminplanes 
	Rahmenplanung und Meilensteineinhaltung 
	Pflege Taskboard & Markus \\ 
	\hline 
	Verantwortlicher Dokumentation & Meilensteinabgabe zusammenstellen
	Protokolle führen
	Unterstützung und Pflege LaTeX & Pascal \\ 
	\hline 
	Fachverantwortliche & Projektstand und Feedback
	Ansprechperson bei Fragen
	Aktualisierung Risikomanagement
	Koordination Versuche und Rechere & I Pascal, ET Jan, M Markus \\ 
	\hline 
\end{tabular} 
...
\begin{tabular}{|l|l|}
	...
	\hline
	DO 08:30-09:00 & Besprechung Team-intern erledigte Aufgaben, Fragen, weiteres Vorgehen \\
	\hline
...
\begin{tabular}{|l|l|l|l|}
	...
	\hline
	x & Laufkatze bleibt während Fahrt stecken / Seilspannung / Antrieb & & \\
	\hline
	x & Laufkatze bleibt nach Anhalten um Ladegut zu heben stecken / Anfahren geht nicht mehr & & \\
	\hline
	x & Kameraqualität zu schwach für Anwendung & & \\
	\hline
	x & Störfaktor Lichteinflüsse von Aussen & & \\
	\hline
	x & Ladegut wird nicht aufgenommen / rutscht ab / zu schwer & & \\
	\hline
	x & Ladegut berührt Hindernisse & & \\
	\hline
	x & Ladegut trifft beim absetzen Zielplatte nicht & & \\
	\hline
	x & Koordinatensystem kann nicht abgebildet werden & & \\
	\hline
	x & Position des Ladeguts wird falsch oder gar nicht angezeigt & & \\
	\hline
\end{tabular}
\newpage
