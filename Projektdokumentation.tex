...
Die Seilwinde ist eine Vorrichtung welche Hauptsächlich aus einer Seiltrommel, Seil und Antrieb besteht. Die Lastaufnahme geschieht durch Zugkräfte am Seil, welche durch das Drehmoment vom Motor erzeugt wird.
	\subsubsection{Anrieb} \label{ssub:Seilantrieb}
...
Überschlägige Berechnungen für den Antrieb ergeben die gleichen Ergebnisse wie beim Antrieb der Seilwinde (\ref{ssub:Seilantrieb}). Bei der Zahnstange ist aus Gewichts- und Kostengründen eine Ausführung aus Kunststoff sinnvoll. Passende Zahnritzel sind online in der Ausführung Edelstahl oder Kunststoff verfügbar, wobei für unsere Anwendung die Kunststoffausführung vollkommen ausreicht. Eine Präzise Führung kann durch mehrere Rollen rund um die Zahnstange gewährleistet werden. Alternativ ist auch ein passendes Gegenstück mit guten Gleiteigenschaften welch gegenüber vom Antrieb montiert wird möglich. Dabei ist zu beachten, dass durch Reibung an den Führungsschiene eine lokale Erwärmung zur Folge hat, wodurch der Kunststoff sich ausdehnt und somit Abweichungen zur Senkrechten entstehen können.
...
Der Vorteil eines Elektromagneten besteht darin, dass kleine Abweichungen in der Position toleriert werden können, da sich der Elektromagnet bei genügender Feldstärke an den magnetischen Haken anschmiegt. Durch Unterbrechung des Stromflusses bricht das Magnetfeld zusammen und die Last kann so  sicher auf das Zielfeld abgesetzt werden. Ein Nachteil besteht darin, dass durch den stark erhöhten Strombedarf die Akkulaufzeit leidet. Des weiteren kann eine Verdrehung und ein Kippen des Klotzes ohne den Einsatz von zusätzliche mechanische Komponenten nicht gewährleistet werden.
