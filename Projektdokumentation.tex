...
Das Startsignal erfolgt mit einem Kippschalter, der am Gerät angebracht ist. Dies bietet gegenüber Akkustischem oder Bluetooth Signal weniger Störungspotential von aussen.
...
Bei der Positionsbestimmung mit dem Schrittmotor ist mit Schlupf bei der Kraftübertragung vom Motor des Antriebs auf das Seil zu rechnen. Deshalb muss dieser unbedingt vermieden werden um die Daten nicht zu verfälschen. Auch der Beschleunigungssensor ist durch eine begrenzte Genauigkeit und durch Restschwingungen Beeinflusst und verfälschen das Resultat zwangsweise. Vor allem die Schwingungen müssen durch das Programm erkannt und ausgeglichen werden. Die Genauigkeit des Sensors kann nicht durch das Programm ausgeglichen werden, deshalb muss zwingend ein Sensor mit ausreichender Genauigkeit ausgewählt werden.
