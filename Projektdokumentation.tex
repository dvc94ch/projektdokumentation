...
Durch vorgängiges evaluieren des Durchhangs in Abhängigkeit der Position in x-Richtung mit dem Gewicht der Laufkatze kann eine Funktionsgleichung erstellt werden. Diese kann in der Software hinterlegt werden und somit kann die Position der Last in z-Richtung in Abhängigkeit der Position in x-Richtung dargestellt werden. Der Vorteil dieser Variante ist, dass nur ein Sensor für die Positionsbestimmung benötigt wird. Die Funktionsgleichung kann einerseits durch rechnen ermittelt werden, anderseits kann durch Anhängen einer Probelast die Kurve durch Auswertung eines Versuches ermittelt werden. Der Vorteil der Funktionsgleichung des Versuchs gegenüber der errechneten Funktionsgleichung ist, dass alle Einflussfaktoren wie Rollreibung, Seil Eigengewicht, Ungenauigkeiten etc. berücksichtigt werden. Dies ist durch berechnen kaum möglich. 
