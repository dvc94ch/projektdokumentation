...
Um die Last mit einem Elektromagnet zu greifen ist eine prezise Positionierung
in x-y notwendig, da das Magnetfeld quadratisch abnimmt, und eine Anziehung des
Magnets an die Last dadurch nicht gut funktioniert. Es wurde versucht die
Grundfläche des Elektromagnets zu vergrössern, wobei sich herausstellte das die
gewählte Geometrie ungeeignet war. Weitere Schwierigkeiten sind bei der Wahl der
Kupferdraht dicke entstanden. Um einen genügend grossen Strom zu erreichen ist ein
kleiner Widerstand notwendig. Dies hatte zur folge das der Elektromagnet bei
kleinen Spannungen betrieben werden musste um nicht zu überhitzen. Eine Pulse
Width Modulation ist notwendig um den Elektromagnet mit höheren Spannungen zu
betreiben. Elektromagnet ist schwieriger zu realisieren als einen Hacken, kann
aber die Last schneller greifen.

\subsection{Evaluation Positionsbestimmung per Schrittmotor}
Positionsbestimmung per Schrittmotor hat den Nachteil das bei variabler Last,
Schritte übersprungen werden können welches die Positionsbestimmung nutzlos
machen könnte. Beim Antrib ist die Last konstant, und darum ist ein Schrittmotor
gut geeignet. Für die Positionsbestimmung der Last könnte es schwieriger werden,
aber ein Lastdelta von 100g sollte nicht zu grösseren Problemen führen. Für die
Positionsbestimmung der Last ist eine zusätzliche Messung notwendig da es nur
die relative Distanz zum Gefährt messen kann und nicht die absolute Höhe.
...
Im Gegensatz zur GCC Toolchain ist die LLVM Toolchain ist noch nicht vollständig
...
Das Rasperry PI ist ein Einplatinencomputer in der Grösse einer Kreditkarte. Das Ein-Chip-System von Broadcom läuft mit einem ARM-Mikroprozessor. Durch seine Bekanntheit, der vielen Module die es dazu fertig gibt, sowie seinem Preis ist das Rasperry PI Pionier auf dem Bereich der Einplatinencomputer.
