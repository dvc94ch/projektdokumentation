...
Überschlägige Berechnungen für den Antrieb ergeben die gleichen Ergebnisse wie beim Antrieb der Seilwinde (siehe \ref{ssub:Seilantrieb}). Bei der Zahnstange ist aus Gewichts- und Kostengründen eine Ausführung aus Kunststoff sinnvoll. Passende Zahnritzel sind online in der Ausführung Edelstahl oder Kunststoff verfügbar, wobei für unsere Anwendung die Kunststoffausführung vollkommen ausreicht. Eine Präzise Führung kann durch mehrere Rollen rund um die Zahnstange gewährleistet werden. Alternativ ist auch ein passendes Gegenstück mit guten Gleiteigenschaften welch gegenüber vom Antrieb montiert wird möglich. Dabei ist zu beachten, dass durch Reibung an den Führungsschiene eine lokale Erwärmung zur Folge hat, wodurch der Kunststoff sich ausdehnt und somit Abweichungen zur Senkrechten entstehen können.
